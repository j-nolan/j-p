...
function register_jp_custom_menu_page () {
	add_menu_page( 'J. pédagogique', 'J. pédagogique', 'manage_options', 'journee-pedagogique', 'display_jp_home');
...
function jp_admin_theme_style() {
    wp_enqueue_style('journee-pedagogique-style', plugins_url('src/wp-admin.css', __FILE__));
}
